                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <section class="container mt-3">
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <form action="{{route('jugadores.store')}}" method="post" class="row g-2 flex-column">
                                    @csrf
                                    <div class="col-md-12">
                                        <label for="exampleInputEmail1" class="form-label">Nombre Jugador</label>
                                        <input type="text" name="nombre_jugador" class="form-control" aria-describedby="emailHelp">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="exampleInputEmail1" class="form-label">pais</label>
                                        <input type="text" name="pais_jugador" class="form-control" aria-describedby="emailHelp">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="exampleInputEmail1" class="form-label">edad</label>
                                        <input type="number" name="edad_jugador" class="form-control" aria-describedby="emailHelp">
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-select" name="numero" aria-label="Default select example">
                                            ...
                                            <option value="{{$numero->numero_camiseta}}">{{$numero->numero_camiseta}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-12">
